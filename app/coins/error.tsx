...
export default function CoinsError({
  ...
  return (
    <main
      ...
      aria-live="assertive"
    >
      <div className="content flex flex-col items-center justify-center min-h-[60vh] text-center gap-6">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-white">Failed to load coins</h2>
          <p className="text-gray-400 mt-2 max-w-md">
            Could not retrieve market data from Binance. Check your connection and try again.
          </p>
        </div>
